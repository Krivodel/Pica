...
- Просмотр изображений, анимаций и многостраничных форматов.
- Мини-плеер для анимаций с возможностью перемотки.
...
- Полноценная поддержка форматов: `.png`, `.jpeg`, `.webp`, `.bmp`, `.gif`, `.ico`, `.cur`, `.avif`, `.heic`, `.heif`, `.tif`.
...
| Предыдущее изображение или анимация внутри файла | `Shift`, `Ctrl` или `Alt` + `A` или `←`                   |
| Следующее изображение или анимация внутри файла  | `Shift`, `Ctrl` или `Alt` + `D` или `→`                   |
| Предыдущий кадр анимации                         | `Б` (`,` в английской раскладке)                          |
| Следующий кадр анимации                          | `Ю` (`.` в английской раскладке)                          |
...
Pica передаёт логи в уже настроенную приложением систему логов и не изменяет её.
